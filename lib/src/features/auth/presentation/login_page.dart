                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        registerMode
                            ? 'Crear una cuenta'
                            : 'Bienvenido a ${branding?.platformName ?? 'Electropoint'}',
                      ...
                      const SizedBox(height: 16),
                       _buildTextField(
                        ...
                        suffix: isValidatingEmail 
                          ...
                          : (emailError == null && email.text.contains('@') ? const Icon(Icons.check_circle, color: Colors.green, size: 20) : null),
                        onChanged: (val) {
                          ...
                          children: [
                            Expanded(
                              ...
                              child: _buildDropdownField(
                                ...
                                items: ['NIT', 'CI'],
                                onChanged: (val) {
                                  if (val != null) setState(() => billingDocType.text = val);
                                },
                              ),
                            ),
                            ...
                            Expanded(
                               ...
                               child: _buildTextField(
                                 ...
                                 errorText: nitError,
                                 onChanged: (val) {
                                   if (nitError != null) setState(() => nitError = null);
                                 },
                                 suffix: isValidatingNit 
                                   ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 2))
                                   : (nitError == null && billingDocument.text.length >= 5 ? const Icon(Icons.check_circle, color: Colors.green, size: 20) : null),
                               ),
                             ),
                          ],
                        ),
                      ...
                      SizedBox(
                        ...
                        child: FilledButton(
                          onPressed:
                              (loading || (registerMode && (emailError != null || nitError != null || isValidatingEmail || isValidatingNit)))
                                  ? null
                                  : () async {
